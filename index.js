...
const UUID = '5efabea4-f6d4-91fd-b8f0-17e004c89c60'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = '';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = '';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = 'your-domain.com';    // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
const AUTO_ACCESS = false;      // 是否开启自动访问保活,false为关闭,true为开启,需同时填写DOMAIN变量
const WSPATH = UUID.slice(0, 8);     // 节点路径，默认获取uuid前8位
const SUB_PATH = 'sub';            // 获取节点的订阅路径
const NAME = '';                       // 节点名称
const PORT = 3000;                     // http和ws服务端口
